...
public class User32 {
    ...
    private static final long PFN_GetKeyboardLayout = apiGetFunctionAddress(LIBRARY, "GetKeyboardLayout");
     ...
     */
    public static long callGetKeyboardLayout(int threadId) {
        return JNI.callPP(threadId, PFN_GetKeyboardLayout);
    }
}
