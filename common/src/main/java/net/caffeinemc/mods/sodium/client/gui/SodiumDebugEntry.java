...
public class SodiumDebugEntry implements DebugScreenEntry {
    private static final Identifier DEBUG_GROUP = Identifier.fromNamespaceAndPath("mercurizer", "debug_group");
    ...
    public void display(DebugScreenDisplayer debugScreenDisplayer, @Nullable Level level, @Nullable LevelChunk levelChunk, @Nullable LevelChunk levelChunk2) {
        debugScreenDisplayer.addToGroup(DEBUG_GROUP, "%sMercurizer Renderer (%s)".formatted(getVersionColor(), SodiumClientMod.getVersion()));
