...
public enum ItemRenderType {
	...
	static {
		var renderTypeToEnum = new LinkedHashMap<RenderType, ItemRenderType>();

		for (var value : ItemRenderType.values()) {
			renderTypeToEnum.put(value.renderType, value);
		}

		RENDER_TYPE_2_ENUM = Map.copyOf(renderTypeToEnum);
	}
