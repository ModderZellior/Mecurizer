...
public class SodiumClientMod {
    ...
    public static final Identifier SODIUM_DEBUG_ENTRY_FULL = Identifier.fromNamespaceAndPath("mercurizer", "debug_full");
    public static final Identifier SODIUM_DEBUG_ENTRY_REDUCED = Identifier.fromNamespaceAndPath("mercurizer", "debug_reduced");
    public static final Identifier SODIUM_FPS_PERCENTILES = Identifier.fromNamespaceAndPath("mercurizer", "fps_percentiles");
