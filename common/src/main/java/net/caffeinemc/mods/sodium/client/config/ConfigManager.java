...
public class ConfigManager {
    public static final String CONFIG_ENTRY_POINT_KEY = "mercurizer:config_api_user";
    ...
    private static void registerConfigs(BiConsumer<ConfigEntryPoint, ConfigBuilder> registerMethod) {
        ...
        ModOptions mercurizerModOptions = null;
        ...
        for (ConfigUser configUser : configUsers) {
            ...
            try {
                ...
                for (var modConfig : builtConfigs) {
                    ...
                    if (configId.equals("mercurizer")) {
                        mercurizerModOptions = modConfig;
                    } else {
        ...
        if (mercurizerModOptions == null) {
            throw new RuntimeException("Mercurizer mod config not found");
        }
        modConfigs.add(0, mercurizerModOptions);
