...
public class SodiumConfigBuilder implements ConfigEntryPoint {
    private static final Identifier MERCURIZER_ICON = Identifier.fromNamespaceAndPath("mercurizer", "textures/gui/config-icon.png");
    ...
    public SodiumConfigBuilder() {
        ...
        this.sodiumStorage = () -> {
            ...
            SodiumClientMod.logger().info("Flushed changes to Mercurizer configuration");
        };
    }
    ...
    public static void registerIcon(TextureManager textureManager) {
        textureManager.registerAndLoad(MERCURIZER_ICON, new SodiumLogo());
    }

    static class SodiumLogo extends ReloadableTexture {
        public SodiumLogo() {
            super(MERCURIZER_ICON);
        }
