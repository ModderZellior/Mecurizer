...
public class MercurizerBenchmarkScreen extends Screen {
    ...
    private void drawProgress(GuiGraphics graphics, float progress, String message, String subtext) {
        int barW = 320, barH = 8;
        ...
        graphics.drawCenteredString(this.font, message, this.width / 2, barY - 16, 0xFFFFFF);
        graphics.drawCenteredString(this.font, subtext, this.width / 2, barY + barH + 8, 0x888888);
    }
